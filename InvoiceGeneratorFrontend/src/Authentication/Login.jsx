...
import { Mail, Lock, Loader2, ArrowRight, ReceiptText } from 'lucide-react'
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative">
                <div className="absolute inset-0 bg-gradient-to-r from-purple-500/20 to-indigo-500/20 backdrop-blur-md z-10" />
                <img
                    src="/media/images/sideImg.jpg"
                    alt="Background"
                ...
                <div className="absolute bottom-10 left-10 text-white z-30 max-w-lg">
                    <h2 className="text-5xl font-bold mb-4 leading-tight">Welcome Back to our Invoice Generator</h2>
                    <p className="text-lg opacity-90">
                        Continue your invoice generation journey with our invoice generator.
                    </p>
                </div>
            </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
                <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-8">
                    <div className="space-y-1 text-center mb-6">
                        ...
                        <h1 className="text-2xl font-bold">Sign In to Invoice Generator</h1>
