...
import { Loader2, UserPlus,ReceiptText, Mail, Lock, ArrowRight } from 'lucide-react';
        ...
        <div className="min-h-screen w-full bg-gradient-to-br from-gray-50 to-gray-100 flex">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative">
                ...
                <div className="absolute bottom-10 left-10 text-white z-30 max-w-lg">
                    <h2 className="text-5xl font-bold mb-4 leading-tight">Generate your invoices with ease</h2>
                    <p className="text-lg opacity-90">
                        Generate your invoices with ease and get paid faster with our invoice generator. 
                    </p>
                </div>
            </div>
